import {
  ...
  invariant,
  require_prop_types
} from "./chunk-Z3QPE4ZF.js";
import {
  hideOthers
} from "./chunk-5IR4NVLK.js";
import {
  Combination_default,
  parseToRgba,
  toHex,
  transparentize
} from "./chunk-4G2GIJRW.js";
import {
...
import {
  ...
  useIsPresent,
  usePresence
} from "./chunk-I4VDDXYV.js";
import {
  createMedium,
  createSidecarMedium,
  useMergeRefs
} from "./chunk-VPCWNXYD.js";
import {
  Global,
  ThemeContext,
  ThemeProvider,
...
function getOwnerWindow(node2) {
  var _a8, _b5;
  return isElement(node2) ? (_b5 = (_a8 = getOwnerDocument(node2)) == null ? void 0 : _a8.defaultView) != null ? _b5 : window : window;
}
...
function ThemeProvider2(props) {
  ...
  const computedTheme = (0, import_react18.useMemo)(() => toCSSVar(theme2), [theme2]);
...
var EnvironmentContext = (0, import_react20.createContext)({
  getDocument() {
    return document;
  },
  getWindow() {
...
function useEnvironment({ defer } = {}) {
  const [, forceUpdate] = (0, import_react20.useReducer)((c) => c + 1, 0);
  useSafeLayoutEffect(() => {
    if (!defer)
      return;
    forceUpdate();
  }, [defer]);
  return (0, import_react20.useContext)(EnvironmentContext);
}
...
var ToastComponent = (0, import_react24.memo)((props) => {
  const {
    id,
    message,
    onCloseComplete,
  ...
  const [delay, setDelay] = (0, import_react24.useState)(duration);
  ...
  const containerStyles = (0, import_react24.useMemo)(
    () => ({
      pointerEvents: "auto",
      maxWidth: 560,
      minWidth: 300,
  ...
  const toastStyle = (0, import_react24.useMemo)(() => getToastStyle(position2), [position2]);
...
function createIcon(options) {
  ...
  const path = import_react25.Children.toArray(options.path);
...
var ToastProvider = (props) => {
  const state2 = (0, import_react26.useSyncExternalStore)(
...
var useSafeLayoutEffect2 = typeof window !== "undefined" ? import_react28.useLayoutEffect : import_react28.useEffect;
...
function useMergeRefs2(...refs) {
  return (0, import_react29.useMemo)(() => mergeRefs2(...refs), refs);
}

// node_modules/@chakra-ui/descendant/dist/chunk-OCNORRQU.mjs
var import_react30 = __toESM(require_react(), 1);
function useDescendants() {
  const descendants = (0, import_react30.useRef)(new DescendantsManager());
...
function useDescendant(options) {
  ...
  const [index, setIndex] = (0, import_react30.useState)(-1);
...
function useControllableState(props) {
  ...
  const [uncontrolledState, setUncontrolledState] = (0, import_react31.useState)(defaultValue);
...
function useAccordionItem(props) {
  ...
  const buttonRef = (0, import_react32.useRef)(null);
  ...
  const onKeyDown = (0, import_react32.useCallback)(
    (event) => {
      const keyMap = {
        ArrowDown: () => {
  ...
  const onFocus3 = (0, import_react32.useCallback)(() => {
    setFocusedIndex(index);
  }, [setFocusedIndex, index]);
  const getButtonProps = (0, import_react32.useCallback)(
  ...
  const getPanelProps = (0, import_react32.useCallback)(
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    const ctx = (0, import_react33.useMemo)(() => context, [context]);
...
var Collapse = (0, import_react34.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var Fade = (0, import_react35.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
...
var ScaleFade = (0, import_react36.forwardRef)(
...
var SlideFade = (0, import_react37.forwardRef)(
...
var Slide = (0, import_react38.forwardRef)(function Slide2(props, ref) {
  const {
...
var Accordion = forwardRef(function Accordion2({ children, reduceMotion, ...props }, ref) {
  ...
  const ctx = (0, import_react39.useMemo)(
...
function useImage(props) {
  ...
  const imageRef = (0, import_react40.useRef)();
  const load = (0, import_react40.useCallback)(() => {
    if (!src)
      return;
    flush();
    const img = new Image();
...
function AvatarImage(props) {
  ...
  if (showFallback) {
    ...
    ) : (0, import_react41.cloneElement)(icon, {
      role: "img",
...
var Avatar = forwardRef((props, ref) => {
  ...
  const [isLoaded, setIsLoaded] = (0, import_react42.useState)(false);
  const {
    src,
    srcSet,
    name,
...
function getValidChildren2(children) {
  return import_react43.Children.toArray(children).filter(
    (child) => (0, import_react43.isValidElement)(child)
  );
}
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index) => {
      ...
      return (0, import_react44.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index) => (0, import_react46.cloneElement)(child, {
        separator,
        spacing: spacing2,
...
function useButtonType(value) {
  const [isButton, setIsButton] = (0, import_react48.useState)(!value);
  const refCallback = (0, import_react48.useCallback)((node2) => {
    if (!node2)
      return;
...
function ButtonIcon(props) {
  ...
  const _children = (0, import_react49.isValidElement)(children) ? (0, import_react49.cloneElement)(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
...
function ButtonSpinner(props) {
  ...
  const spinnerStyles = (0, import_react50.useMemo)(
    () => ({
      display: "flex",
      alignItems: "center",
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react51.useMemo)(() => {
...
var IconButton = forwardRef(
  (props, ref) => {
    ...
    const _children = (0, import_react52.isValidElement)(element) ? (0, import_react52.cloneElement)(element, {
      "aria-hidden": true,
      focusable: false
    }) : null;
...
function useCheckboxGroup(props = {}) {
  ...
  const getCheckboxProps = (0, import_react53.useCallback)(
    (props2 = {}) => {
...
function CheckboxGroup(props) {
  ...
  const group = (0, import_react54.useMemo)(
    () => ({
      size: size2,
      onChange,
      colorScheme,
...
function useInitialAnimationState(isChecked) {
  const [previousIsChecked, setPreviousIsChecked] = (0, import_react55.useState)(isChecked);
  const [shouldAnimate, setShouldAnimate] = (0, import_react55.useState)(false);
...
function useFormControlProvider(props) {
  ...
  const getHelpTextProps = (0, import_react56.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
       ...
       */
      ref: mergeRefs2(forwardedRef, (node2) => {
        if (!node2)
          return;
        setHasHelpText(true);
      })
...
function useCheckbox(props = {}) {
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react57.useState)(false);
  const [isFocused, setFocused] = (0, import_react57.useState)(false);
  const [isHovered, setHovered] = (0, import_react57.useState)(false);
  const [isActive, setActive] = (0, import_react57.useState)(false);
  (0, import_react57.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const inputRef = (0, import_react57.useRef)(null);
  const [rootIsLabelElement, setRootIsLabelElement] = (0, import_react57.useState)(true);
  const [checkedState, setCheckedState] = (0, import_react57.useState)(!!defaultChecked);
  ...
  const onKeyUp = (0, import_react57.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getIndicatorProps = (0, import_react57.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      "data-active": dataAttr(isActive),
  ...
  const getInputProps = (0, import_react57.useCallback)(
    (props2 = {}, forwardedRef = null) => {
      return {
        ...props2,
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const iconStyles = (0, import_react58.useMemo)(
    () => ({
  ...
  const clonedIcon = (0, import_react58.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react59.useState)(() => {
    var _a8;
  ...
  const decimalPlaces = getDecimalPlaces(parse3(value), stepProp);
  const precision = precisionProp != null ? precisionProp : decimalPlaces;
  const update = (0, import_react59.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
      ...
      onChangeProp == null ? void 0 : onChangeProp(next.toString(), parse3(next));
    },
    [onChangeProp, isControlled, value]
  );
  const clamp = (0, import_react59.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react59.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse3(step);
      } else {
        next = parse3(value) + step;
      }
      next = clamp(next);
      update(next);
    },
  ...
  const decrement = (0, import_react59.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse3(-step);
  ...
  const castValue = (0, import_react59.useCallback)(
    (value2) => {
      var _a8;
...
function cast2(value, step, precision) {
  const parsedValue = parse3(value);
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react61.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  });
  const [prevValue, setPrevValue] = (0, import_react61.useState)(value);
  const inputRef = (0, import_react61.useRef)(null);
  const previewRef = (0, import_react61.useRef)(null);
  const editButtonRef = (0, import_react61.useRef)(null);
  const cancelButtonRef = (0, import_react61.useRef)(null);
  const submitButtonRef = (0, import_react61.useRef)(null);
  ...
  const onEdit = (0, import_react61.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react61.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  const onCancel = (0, import_react61.useCallback)(() => {
    setIsEditing(false);
    setValue(prevValue);
    onCancelProp == null ? void 0 : onCancelProp(prevValue);
    onBlurProp == null ? void 0 : onBlurProp(prevValue);
  }, [onCancelProp, onBlurProp, setValue, prevValue]);
  const onSubmit = (0, import_react61.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react61.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react61.useCallback)(
    (event) => {
      var _a8;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react61.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react61.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react61.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react61.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react61.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
var focusScope = (0, import_react62.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = React4.forwardRef(function FocusLockUI(props, parentRef) {
  var _extends2;
  ...
  var _React$useState2 = React4.useState({}), update = _React$useState2[1];
  ...
  var _React$useState3 = React4.useState({}), id = _React$useState3[0];
  var onActivation = React4.useCallback(function(_ref2) {
  ...
  var focusScopeValue = React4.useMemo(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return React4.createElement(React4.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? React4.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && React4.createElement(SideCar, {
    id,
    ...
    focusOptions,
    noFocusGuards
  }), React4.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), React4.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && React4.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
  ...
  return function wrap4(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react63.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
var restoreFocusTo = function(location) {
  ...
  for (var _i = 0, stack_1 = stack; _i < stack_1.length; _i++) {
    ...
    if (parent_1 && ownerDocument.contains(parent_1)) {
      var left2 = (_b5 = line.left) === null || _b5 === void 0 ? void 0 : _b5.call(line);
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = React7.forwardRef(function FocusLockUICombination(props, ref) {
  return React7.createElement(Lock_default, _extends({
...
function MoveFocusInside(_ref2) {
  ...
  return React9.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled3), {
    ref,
    className
  }), children);
}
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react66.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react66.useCallback)(() => {
    var _a24;
...
function useShortcut(props = {}) {
  ...
  const [keys2, setKeys] = (0, import_react68.useState)([]);
...
var useSafeLayoutEffect3 = isBrowser ? import_react69.useLayoutEffect : import_react69.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react70 = __toESM(require_react(), 1);
function useCallbackRef2(fn2, deps = []) {
  const ref = (0, import_react70.useRef)(fn2);
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react72.useRef)();
...
function useEventListener2(event, handler, env, options) {
  ...
  (0, import_react76.useEffect)(() => {
    var _a8;
    const node2 = (_a8 = runIfFn3(env)) != null ? _a8 : document;
    if (!handler) {
      return;
    }
    node2.addEventListener(event, listener, options);
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react77.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react78.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react80.useRef)(null);
  const handlers2 = {
...
function useId3(idProp, prefix) {
  const id = (0, import_react81.useId)();
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react81.useState)(null);
  const ref = (0, import_react81.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react82.useCallback)(
    (next) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react83.useState)(props.defaultIsOpen || false);
  ...
  const onToggle = (0, import_react83.useCallback)(() => {
...
function useEventListenerMap() {
  const listeners = (0, import_react84.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add3 = (0, import_react84.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react84.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react85.useRef)(false);
  const effectCycleRef = (0, import_react85.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react86.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react86.useRef)(visible);
  useSafeLayoutEffect3(() => {
  ...
  const onFocus3 = (0, import_react86.useCallback)(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react87.useRef)(false);
  const [count, setCount] = (0, import_react87.useState)(0);
  useUnmountEffect(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react88.useState)(isOpen);
  const [once2, setOnce] = (0, import_react88.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react89.useState)(initialState2);
  const callbacks = (0, import_react89.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react90.useState)(false);
  const [valueState, setValueState] = (0, import_react90.useState)(value);
  (0, import_react90.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react90.useCallback)(() => {
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react93.cloneElement)(child, theming) : (0, import_react93.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react94.useMemo)(
    () => shouldWrapChildren ? import_react94.Children.map(children, (child, index) => (0, import_jsx_runtime76.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react95.useMemo)(
    () => getDividerStyles({ spacing: spacing2, direction: direction2 }),
    [spacing2, direction2]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react95.useMemo)(() => {
    const validChildren = getValidChildren2(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react95.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime79.jsxs)(import_react95.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react96.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime85.jsx)(import_jsx_runtime85.Fragment, { children: chunks.map((chunk2, index) => {
    return chunk2.match ? (0, import_jsx_runtime85.jsx)(Mark, { sx: styles2, children: chunk2.text }, index) : (0, import_jsx_runtime85.jsx)(import_react96.Fragment, { children: chunk2.text }, index);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  const styles2 = (0, import_react97.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
  ...
  return (0, import_jsx_runtime89.jsx)(
    chakra.div,
    {
      ...
      _before: {
        ...
        content: `""`,
        display: "block",
        paddingBottom: mapResponsive2(ratio, (r) => `${1 / r * 100}%`)
      },
      __css: {
        "& > *:not(style)": {
          overflow: "hidden",
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react99.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys2, setKeys] = (0, import_react100.useState)([]);
...
function useEventListeners() {
  const listeners = (0, import_react101.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add3 = (0, import_react101.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react101.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react102.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react102.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react102.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react102.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react102.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react102.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled3) {
  ...
  const handleMouseUp = (0, import_react102.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react102.useCallback)(
    (event) => {
      if (isDisabled3) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react102.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions3) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react103.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react103.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
  ...
  const onFocus3 = (0, import_react103.useCallback)(() => {
    if (!visible || !element || !autoFocusRef.current)
      return;
    autoFocusRef.current = false;
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react104.useRef)(null);
  const popper2 = (0, import_react104.useRef)(null);
  const instance = (0, import_react104.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction2);
  const cleanup = (0, import_react104.useRef)(() => {
  });
  const setupPopper = (0, import_react104.useCallback)(() => {
    var _a8;
  ...
  const referenceRef = (0, import_react104.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react104.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react104.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react105.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react105.useId)();
  const id = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react105.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react105.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    handleOpen == null ? void 0 : handleOpen();
  }, [isControlled, handleOpen]);
  const onToggle = (0, import_react105.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useAnimationState2(props) {
  ...
  const [once2, setOnce] = (0, import_react107.useState)(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react108.useRef)(null);
  const buttonRef = (0, import_react108.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react108.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a8;
      (_a8 = menuRef.current) == null ? void 0 : _a8.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react108.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react108.useCallback)(() => {
    const id2 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react108.useCallback)(() => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react108.useState)(-1);
  useUpdateEffect(() => {
    if (!isOpen) {
      setFocusedIndex(-1);
    }
  ...
  const openAndFocusMenu = (0, import_react108.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react108.useRef)(/* @__PURE__ */ new Set([]));
  ...
  const openAndFocusFirstItem = (0, import_react108.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react108.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react108.useCallback)(() => {
    var _a8, _b5;
  ...
  const rafId = (0, import_react108.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react108.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react108.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled3 && !isFocusable3
  });
  const onMouseEnter = (0, import_react108.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react108.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react108.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react108.useCallback)(
    (event) => {
...
function useMenuOptionGroup(props = {}) {
  ...
  const onChange = (0, import_react108.useCallback)(
    (selectedValue) => {
  ...
  const clones = validChildren.map((child) => {
    ...
    return (0, import_react108.cloneElement)(child, {
      type,
      onClick,
      isChecked
    });
...
var Menu = (props) => {
  ...
  const context = (0, import_react109.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react110.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react111.isValidElement)(child) ? (0, import_react111.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react112.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react113.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react114.useRef)(null);
  const overlayRef = (0, import_react114.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react114.useRef)(null);
  const onMouseDown = (0, import_react114.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react114.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react114.useState)(false);
  const getDialogProps = (0, import_react114.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react114.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react114.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useIds3(idProp, ...prefixes) {
  const reactId = (0, import_react114.useId)();
  const id = idProp || reactId;
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react120.useState)(false);
  const [action, setAction] = (0, import_react120.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react120.useState)(true);
  ...
  const up = (0, import_react120.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react120.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react120.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const sanitize = (0, import_react121.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse4 = (0, import_react121.useCallback)(
    (value) => {
      var _a8;
  ...
  const format = (0, import_react121.useCallback)(
    (value) => {
      var _a8;
  ...
  const increment = (0, import_react121.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react121.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const onChange = (0, import_react121.useCallback)(
    (event) => {
  ...
  const _onFocus = (0, import_react121.useCallback)(
    (event) => {
      var _a8, _b5, _c3;
  ...
  const spinUp = (0, import_react121.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react121.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react121.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react121.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react122.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const uuid = (0, import_react123.useId)();
  const id = idProp != null ? idProp : `pin-input-${uuid}`;
  const descendants = usePinInputDescendants();
  const [moveFocus2, setMoveFocus] = (0, import_react123.useState)(true);
  const [focusedIndex, setFocusedIndex] = (0, import_react123.useState)(-1);
  ...
  const focusNext = (0, import_react123.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react123.useCallback)(
  ...
  const clear = (0, import_react123.useCallback)(() => {
    var _a8;
  ...
  const getNextValue = (0, import_react123.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren2(children).map(
    (child) => (0, import_react124.cloneElement)(child, { __css: styles2 })
  );
...
function PopoverTrigger(props) {
  const child = import_react125.Children.only(props.children);
  const { getTriggerProps } = usePopoverContext();
  return (0, import_react125.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react126.useRef)(null);
  const triggerRef = (0, import_react126.useRef)(null);
  const popoverRef = (0, import_react126.useRef)(null);
  const isHoveringRef = (0, import_react126.useRef)(false);
  const hasBeenOpened = (0, import_react126.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react126.useState)(false);
  const [hasBody, setHasBody] = (0, import_react126.useState)(false);
  ...
  const getPopoverProps = (0, import_react126.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react126.useCallback)(
  ...
  const getAnchorProps = (0, import_react126.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react126.useRef)();
  const closeTimeout = (0, import_react126.useRef)();
  const maybeReferenceRef = (0, import_react126.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react126.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react126.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
      ref: mergeRefs2(ref, (node2) => {
        setHasHeader(!!node2);
      })
    }),
    [headerId]
  );
  const getBodyProps = (0, import_react126.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs2(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react127.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react127.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const focus2 = (0, import_react128.useCallback)(() => {
  ...
  const getRadioProps = (0, import_react128.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react129.useMemo)(
    () => ({
      name,
      size: size2,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react130.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react130.useState)(false);
  const [isFocused, setFocused] = (0, import_react130.useState)(false);
  const [isHovered, setHovering] = (0, import_react130.useState)(false);
  const [isActive, setActive] = (0, import_react130.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react130.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react130.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react130.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
  ...
  const getInputProps = (0, import_react130.useCallback)(
    (props2 = {}, ref = null) => {
      const trulyDisabled = isDisabled3 && !isFocusable3;
      return {
        ...props2,
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react131.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime140.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react131.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react132.useRef)(true);
...
var SkipNavLink = forwardRef(
  function SkipNavLink2(props, ref) {
    ...
    return (0, import_jsx_runtime144.jsx)(chakra.a, { ...rest, ref, href: `#${id}`, __css: getStyles(styles2) });
  }
);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react136.useLayoutEffect : import_react136.useEffect;
...
function useSizes({
  ...
  const [sizes24, setSizes] = (0, import_react136.useState)([]);
...
function useRangeSlider(props) {
  ...
  const [activeIndex, setActiveIndex] = (0, import_react137.useState)(-1);
  const isInteractive = !(isDisabled3 || isReadOnly);
  const initialValue = (0, import_react137.useRef)(valueState);
  ...
  const rootRef = (0, import_react137.useRef)(null);
  ...
  const actions = (0, import_react137.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react137.useMemo)(
    () => getStyles2({
      isReversed,
      orientation,
      thumbRects,
  ...
  const getRootProps = (0, import_react137.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getInnerTrackProps = (0, import_react137.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getOutputProps = (0, import_react137.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react137.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react138.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react139.useState)(false);
  const [isFocused, setFocused] = (0, import_react139.useState)(false);
  const isInteractive = !(isDisabled3 || isReadOnly);
  const tenSteps = (max2 - min2) / 10;
  const oneStep = step || (max2 - min2) / 100;
  ...
  const trackRef = (0, import_react139.useRef)(null);
  const thumbRef = (0, import_react139.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react139.useCallback)(
    (event) => {
      var _a24, _b5;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react139.useCallback)(
    (value2) => {
      const state22 = stateRef.current;
  ...
  const actions = (0, import_react139.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react139.useMemo)(() => {
    const state22 = stateRef.current;
  ...
  const focusThumb = (0, import_react139.useCallback)(() => {
    const state22 = stateRef.current;
  ...
  const getRootProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getTrackProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs2(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react139.useCallback)(
    (props2, ref = null) => {
  ...
  const getInputProps = (0, import_react139.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react140.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react141.useState)(index);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react142.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react142.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react142.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing2,
      ...styles2.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react143.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react143.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react144.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react145.useRef)();
  const clearEnterTimeout = (0, import_react145.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react145.useRef)();
  const clearExitTimeout = (0, import_react145.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react145.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react145.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react145.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react145.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react145.useCallback)(() => {
  ...
  const getTooltipPositionerProps = (0, import_react145.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react145.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles2 = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    trigger2 = (0, import_react146.cloneElement)(
      child,
