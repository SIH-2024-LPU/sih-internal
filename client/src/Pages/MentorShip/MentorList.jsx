...
//       filtered = filtered.filter(mentor => 
//         selectedSkills.every(skill => mentor.skills && mentor.skills.includes(skill))
//       );
//     }

//     if (selectedCompanies.length > 0) {
//       filtered = filtered.filter(mentor => 
//         selectedCompanies.some(company => mentor.companiesJoined && mentor.companiesJoined.includes(company))
//       );
//     }
