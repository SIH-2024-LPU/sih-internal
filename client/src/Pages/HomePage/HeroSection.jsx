...
//   const careerOptions = [
//     { title: "RoadMap", desc: "Generate your career pathway", link: "/combinedquiz", icon: Rocket, bgColor: "bg-green-100" },
//     { title: "Mentorship", desc: "Book a session with Mentor", link: "/mentorship", icon: BookOpen, bgColor: "bg-pink-100" },
//     { title: "Community", desc: "Gather insights from Experts",link: "/community", icon: Briefcase, bgColor: "bg-blue-100" },
