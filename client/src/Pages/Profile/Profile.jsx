...
// import { Link } from "react-router-dom"; // Replacing next/link with react-router-dom
...
//                 Maths: 95%, Science: 93%, English: 90%
//               </p>
//             </CardContent>
//           </Card>
//           <Card>
...
//               <p className="text-xs text-muted-foreground mt-1">
//                 Maths: 92%, Physics: 88%, Chemistry: 90%
//               </p>
//             </CardContent>
//           </Card>
//           <Card>
...
//                 <li className="text-sm">Software Developer</li>
//                 <li className="text-sm">Data Scientist</li>
//                 <li className="text-sm">AI/ML Engineer</li>
//               </ul>
//             </CardContent>
//           </Card>
//         </div>
...
//               <Link to="/add-project"> {/* Using Link from react-router-dom */}
//                 <Button size="sm">
...
//               <li className="flex justify-between items-center">
//                 <div>
//                   <h3 className="font-medium">Machine Learning Model</h3>
//                   <p className="text-sm text-gray-500">Python, TensorFlow</p>
//                 </div>
...
//                   <p className="text-sm text-gray-500">React Native, Firebase</p>
//                 </div>
...
//               <Link to="/add-certification"> {/* Using Link from react-router-dom */}
//                 <Button size="sm">
//                   <Plus className="w-4 h-4 mr-2" />
//                   Add Certification
//                 </Button>
...
//                 </div>
//                 <span className="text-green-500 font-medium">Achieved</span>
//               </li>
//               <li className="flex justify-between items-center">
//                 <div>
//                   <h3 className="font-medium">Google Cloud Professional Data Engineer</h3>
...
//                   <p className="text-sm text-gray-500">Microsoft Azure</p>
//                 </div>
//                 <span className="text-blue-500 font-medium">Planned</span>
//               </li>
//             </ul>
...
//               <Link to="/add-goal"> {/* Using Link from react-router-dom */}
//                 <Button size="sm">
//                   <Plus className="w-4 h-4 mr-2" />
//                   Add Goal
//                 </Button>
...
//               <li className="flex justify-between items-center">
//                 <div>
//                   <h3 className="font-medium">Learn GraphQL</h3>
//                   <p className="text-sm text-gray-500">Complete online course and build a project</p>
//                 </div>
//                 <span className="text-yellow-500 font-medium">In Progress</span>
//               </li>
//               <li className="flex justify-between items-center">
//                 <div>
//                   <h3 className="font-medium">Contribute to Open Source</h3>
//                   <p className="text-sm text-gray-500">Make 5 meaningful contributions to GitHub projects</p>
//                 </div>
//                 <span className="text-blue-500 font-medium">Ongoing</span>
//               </li>
//               <li className="flex justify-between items-center">
//                 <div>
//                   <h3 className="font-medium">Publish a Technical Blog Post</h3>
//                   <p className="text-sm text-gray-500">Write and publish on Medium or personal blog</p>
//                 </div>
