...
//                       </h3>
//                       <p className="text-xl leading-relaxed text-gray-700">{job.jobDescription}</p>
//                     </div>
//                     <div>
//                       <h3 className="text-3xl font-bold flex items-center text-indigo-700 mb-4">
...
//                   <h3 className="text-3xl font-bold flex items-center text-indigo-700 mb-4">
//                     <School className="mr-3 h-8 w-8" /> Required Education
//                   </h3>
...
//                           <h4 className="text-xl font-bold mb-2 text-indigo-700">{edu.college}</h4>
...
//     if (!job.requiredEducation || job.requiredEducation.length === 0) {
...
//     if (!job.challenges || job.challenges.length === 0) {
//       return <p>No challenges information available.</p>;
//     }
//     return (
//       <ul className="space-y-2">
//         {job.challenges.map((challenge, index) => (
...
//       return <p>No rewards information available.</p>;
//     }
//     return (
//       <ul className="space-y-2">
//         {job.rewards.map((reward, index) => (
...
//                         <BookOpen className="mr-3 h-8 w-8" /> Job Description
//                       </h3>
//                       <p className="text-xl leading-relaxed text-gray-700">{job.jobDescription || 'No job description available.'}</p>
//                     </div>
//                     <div>
//                       <h3 className="text-3xl font-bold flex items-center text-indigo-700 mb-4">
//                         <Sparkles className="mr-3 h-8 w-8" /> Key Skills
