...
//       try {
//         const response = await axios.get(`${config.API_BASE_URL}/recommendations/job-titles`);
...
//         params: { jobTitle }
//       });
//       const jobDetails = response.data.find(job => job.jobTitle === jobTitle);
//       if (jobDetails) {
...
//               <Button onClick={() => handleJobSelect(title)}>View Details</Button>
//             </CardContent>
//           </Card>
//         ))}
//       </div>
...
//         navigate('/job-details', { state: { job: jobDetails } });
//       } else {
//         console.error('Job details not found or error occurred:', jobDetails.error);
