...
//     setIsLoading(true);
//     try {
//       await axios.post(`${config.API_BASE_URL}/recommendations`, formData);
...
//       try {
//         await axios.delete(`${config.API_BASE_URL}/recommendations`);
//         toast.success("All recommendations deleted");
//         // Reset form or fetch updated data
//       } catch (error) {
//         toast.error("Failed to delete recommendations");
//       }
//     }
//   };

//   const renderSelect = (name, options, placeholder) => (
//     <Select onValueChange={(value) => handleInputChange(name, value)} value={formData[name]}>
...
//       <CardHeader>
//         <CardTitle className="text-2xl font-bold text-gray-800">Recommendation Form</CardTitle>
//       </CardHeader>
//       <CardContent>
...
//               {renderSelect(`requiredEducation[${index}].college`, 
//                 dropdownData.colleges.map(college => ({ value: college.name, label: college.name })),
//                 'Select College'
//               )}
//               <Input
//                 value={edu.fees}
...
//             </Button>
//             <Button onClick={handleDeleteAll} type="button" className="w-full bg-red-600 hover:bg-red-700 text-white">
...
// //     setIsLoading(true);
// //     try {
// //       // Filter out empty requiredEducation entries
// //       const filteredFormData = {
// //         ...formData,
// //         requiredEducation: formData.requiredEducation.filter(edu => edu.college.trim() !== '')
// //       };
// //       console.log('Submitting form data:', filteredFormData);
// //       await axios.post(`${config.API_BASE_URL}/recommendations`, filteredFormData);
// //       toast.success("Recommendation added successfully");
// //       // Reset form or fetch updated data
// //     } catch (error) {
...
//     setIsLoading(true);
//     try {
//       // Process requiredEducation correctly
...
//   <div key={index} className="flex space-x-2">
//     <Select 
//       onValueChange={(value) => handleArrayInputChange(index, 'requiredEducation', { ...edu, college: value })} 
//       value={edu.college}
//     >
//       <SelectTrigger className="w-full">
