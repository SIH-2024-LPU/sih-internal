    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-cover bg-center" style={{backgroundImage: "url('/login.jpg')"}}>
        <div className="w-full flex flex-col justify-center items-center  bg-opacity-50 p-12">
          ...
          >
            <h1 className="text-4xl font-bold mb-4">Spark Career Guidance Portal</h1>
            <p className="text-xl mb-8">Empowering Your Future, Igniting Your Potential</p>
            <ul className="text-left list-disc list-inside">
              <li className="mb-2">Expert career advice and mentorship</li>
              <li className="mb-2">Personalized skill development plans</li>
