    ...
    >
      <Card className="w-full max-w-md mx-auto bg-gradient-to-br from-blue-50 to-indigo-100 shadow-lg">
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="flex justify-between w-full text-sm">
            <Button variant="link" className="px-0 text-indigo-600 hover:text-indigo-700">Forgot password?</Button>
            <Button variant="link" className="px-0 text-indigo-600 hover:text-indigo-700">Create an account</Button>
          </div>
        </CardFooter>
      </Card>
    </motion.div>
